...
async def test_google_ingest():
    ...
    print(f"[PASS] Initial Seed State ({len(initial_quotes)} symbols loaded): PASSED")
    ...
    print(f"[PASS] Live Ingestion Batch ({len(batch1)} quotes generated in {latency_ms:.2f}ms): PASSED")
    ...
    print("[PASS] Full Quote Schema Compliance: PASSED")
    ...
    print("[PASS] Canvas Sparkline History Alignment: PASSED")
    ...
    print("[PASS] Upper/Lower Circuit Guardrail Bounds: PASSED")
